...
variable "sonarqube_dns_alias" {
  type        = string
  description = <<EOF
The DNS alias to be associated with the deployed sonarqube instance. Alias will
be created in the given route53 zone
EOF
...
variable "private_subnet_ids" {
  type        = list(string)
  description = "A list of subnets for the fargate service. Should be private"
  #   default = ["subnet-5d12c221","subnet-2178df6d","subnet-29452043"]
}
